...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] === 0) {
        $newImage = uploadFile($_FILES['image'], '../assets/images/products/');
        if ($newImage) {
            $image = $newImage;
        } else {
        ...
        <div class="admin-main">
            <div class="container-fluid">
                <div class="admin-card">
                    ...
                    <form action="edit-product.php?id=<?php echo $productId; ?>" method="post" enctype="multipart/form-data" class="admin-form">
                        <div class="row">
                            <div class="col-md-8">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="is_featured" name="is_featured" <?php echo $product['is_featured'] ? 'checked' : ''; ?>>
                        ...
                        <button type="submit" class="btn btn-primary btn-save">Update Product</button>
                    </form>
                </div>
            </div>
        </div>
